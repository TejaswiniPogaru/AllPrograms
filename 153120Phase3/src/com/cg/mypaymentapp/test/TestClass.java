...
public class TestClass {
	...
	public void testGetMobileNo() {
		Customer cust = new Customer();
		assertEquals("9866317016",cust.getMobileNo());
	}
	@Test
	public void testgetBalance() {
		Wallet wallet = new Wallet(new BigDecimal(5000));
		Customer cust = new Customer("Capgemini","9866317016",wallet);		
		assertEquals(new BigDecimal(5000),cust.getWallet().getBalance());
	}
